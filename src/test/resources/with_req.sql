...
INSERT INTO requests (request_sender, request_receiver, request_book_sender_wants, request_status, request_comment) VALUES (1, 2, 3, 'ACTUAL', 'Прошу обменяться этой книгой.');
INSERT INTO requests (request_sender, request_receiver, request_book_sender_wants, request_status, request_comment) VALUES (3, 2, 3, 'ACTUAL', 'Хочу получить вашу книгу в обмен на мою.');
INSERT INTO requests (request_sender, request_receiver, request_book_sender_wants, request_status, request_comment) VALUES (3, 2, 2, 'ACTUAL', 'Хочу получить вашу книгу в обмен на мою.');
